...
/**
 * PassingLog2 for generating IBM trace log for testing Analyser.
 * 
 * Commands to compile and get log trace :-
 * $ javac FailingLog1.java
 * $ java -Xtrace:none -Xtrace:maximal=FailingLog1,output=FailingLog1.trc FailingLog1
 * $ java com.ibm.jvm.TraceFormat FailingLog1.trc FailingLog1.fmt
 * 
 * @author Manjot Sidhu
 */
public class FailingLog1 {
    ...
    public static void main(String[] args) {
        ...
        // Register a trace application called FailingLog1
        handle = Trace.registerApplication("FailingLog1", templates);
