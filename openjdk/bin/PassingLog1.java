...
/**
 * PassingLog1 for generating IBM trace log for testing Analyser.
 * 
 * Commands to compile and get log trace :-
 * $ javac PassingLog1.java
 * $ java -Xtrace:none -Xtrace:maximal=PassingLog1,output=PassingLog1.trc PassingLog1
 * $ java com.ibm.jvm.TraceFormat PassingLog1.trc PassingLog1.fmt
 * 
 * @author Manjot Sidhu
 */
public class PassingLog1 {
    ...
    public static void main(String[] args) {
        ...
        // Register a trace application called PassingLog1
        handle = Trace.registerApplication("PassingLog1", templates);
